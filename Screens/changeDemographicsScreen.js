...
import { View, StyleSheet, Text, AsyncStorage, ScrollView, TouchableOpacity, Image, Picker } from 'react-native'
import { to } from '../components/util'
import FeedbackFeedItem from '../components/FeedbackFeedItem'
import firebaseApp from '../firebaseApp'

export default class changeDemographicsScreen extends React.Component {
  state = {
    gender: '',
    race: '',
    income: '',
  ...
  render() {
    ...
    return (
      ...
      <View style={styles.container}>
        ...
        />
        <Text style={{marginLeft: 30, marginRight: 30, textAlign: 'center', fontSize: 16}}>The Acta team is dedicated to our mission to connect you with unbiased, informative, and relevant local news and updates. We request the demographic information of our users in order to get to know those who are using our platform. The more familiar we are with you and what you value, the more accurate our algorithms are. Please fill in as much information as you feel comfortable sharing with us. We are committed to protecting your privacy.</Text>
      <View>
      <Picker
