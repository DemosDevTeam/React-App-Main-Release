  ...
  render() {
   ...
   return (
      <View style={styles.container}>
        ...
        <TextInput secureTextEntry={true} placeholder="Password" onChangeText={this.handlePassword} style={{marginTop: 10, marginBottom: 15, marginLeft: 75, marginRight: 75, backgroundColor: '#ffffff', borderRadius: 3}}/>
        </View>
